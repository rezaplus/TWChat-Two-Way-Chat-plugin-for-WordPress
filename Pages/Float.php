...
<style>
    ...
    .TWCHFloatBtn {
        ...
        <?php if ($float_padding2 != 0) : ?>background-color: <?php echo esc_html($float_option['floatBackground2']); ?>;
        <?php endif ?>
    }
    ...
    .TWCHFloatBtn div {
        ...
        <?php if ($float_padding1 != 0) : ?>background-color: <?php echo esc_html($float_option['floatBackground1']); ?>;
        <?php endif ?>
    }
    ...
    .TWCHBoxHeader .TWCHFloatBoxTitle {
        color: <?php echo esc_html($float_option['floatBoxTextColor']); ?> !important;
    }
